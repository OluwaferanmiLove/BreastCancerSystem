          ...
          <ScrollView style={{ flex: 1 }}>
            <View style={{ marginTop: hp(10) }}>
              <View style={modalStyles.content}>
                ...
                <Text style={[modalStyles.title, {fontWeight: 'normal', marginTop: hp(15)}]}>You may be PREGNANT. Changes in the way your breasts feel, fatigue, nausea and frequent urination are some of the early signs of pregnancy.</Text>
                <Button width={wp(160)} marginTop={hp(30)} title={'Okay'} />
              </View>
            </View>
          </ScrollView>
        </View>
